...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		// Código que crea los elementos-interfáz gráfica
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				//Activa el evento, después de que el usuario seleccionar las fechas se debe calcular el valor de la reserva
			}
		});
	...
	//Código que permite mover la ventana por la pantalla
