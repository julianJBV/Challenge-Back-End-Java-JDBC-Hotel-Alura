...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    JLabel lblNewLabel_1 = new JLabel("Sistema de reservas Hotel");
	    ...
	    String textoDescripcion = "<html><body>Sistema de reserva de hotel. Controlar y administrar <br> el flujo de reservas y de huespédes del hotel </body></html>";
	    ...
	    JLabel lblNewLabel_3_1 = new JLabel("- Editar Reservas y Huéspedes existentes");
